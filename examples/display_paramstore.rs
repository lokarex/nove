...
fn main() {
    ...
    let mut root = SafeTensorsParamStore::new("CompositeModel");

    // Create a submodule1
    let mut submodule1 = SafeTensorsParamStore::new("(feature_extractor): FeatureExtractor");
    submodule1
    ...
    // Create a submodule2
    let mut submodule2 = SafeTensorsParamStore::new("(classifier): Classifier");
    submodule2
        .set_module(SafeTensorsParamStore::new(
    ...
    root.set_module(SafeTensorsParamStore::new(
